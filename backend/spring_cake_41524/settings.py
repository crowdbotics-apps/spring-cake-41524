"""
Django settings for spring_cake_41524 project.
...
ROOT_URLCONF = 'spring_cake_41524.urls'
...
WSGI_APPLICATION = 'spring_cake_41524.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_cake_41524 API",
    "DESCRIPTION": "API documentation for spring_cake_41524 App",
    "VERSION": "v1",
}
